...
class Parameter:
    ...
    def get_mat(self, df: DataFrame) -> NDArray:
    ...
    def get_param(self, coefs: NDArray, df: DataFrame, mat: NDArray = None) -> NDArray:
        """Get the parameter.
    ...
    def get_dparam(self, coefs: NDArray, df: DataFrame, mat: NDArray = None) -> NDArray:
    ...
    def get_d2param(
        self, coefs: NDArray, df: DataFrame, mat: NDArray = None
    ) -> NDArray:
